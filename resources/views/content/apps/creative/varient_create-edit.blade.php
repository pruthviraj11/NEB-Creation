...
@section('content')
    @if ($page_data['form_title'] == 'Add New Varient')
        <form action="{{ route('app-varient-store') }}" method="POST" enctype="multipart/form-data">
            @csrf
        @else
            <form action="{{ route('app-varient-update', encrypt($varient->id)) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 mb-1">
                                ...
                                <input type="text" id="size" class="form-control" placeholder="Size"
                                    name="size"
                                    value="{{ old('size') ?? ($varient != '' ? $varient->title : '') }}">
