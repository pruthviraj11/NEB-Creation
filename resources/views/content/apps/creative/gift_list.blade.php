...
@section('title', 'Gift Product Lists')
    ...
    <section class="app-user-list">
        ...
        <div class="card mt-5">
            <div class="card-header">
                <h4 class="card-title">Gift Product Lists</h4>
                <a href="{{ route('app-gift_product-add') }}" class="col-md-2 btn btn-primary">Add Gift Product
                </a>
            </div>
