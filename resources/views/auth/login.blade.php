    ...
    <div class="authentication-wrapper authentication-cover authentication-bg">
        <div class="authentication-inner row">
            ...
            <div class="d-flex col-12 col-lg-12 align-items-center p-sm-5 p-4">
                <img src="{{ asset('home/logo/neb_logo.png') }}" alt="Logo" class="img-fluid mx-auto d-block" style="max-width:35%; height: auto;">
                ...
                <div class="w-px-400 mx-auto">
                    ...
                    <h3 class="mb-1 text-center">Welcome to NEB Creation</h3>
