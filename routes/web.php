...
Route::get('guestId/{guest_id}', [FrontController::class, 'checkGuestId'])->name('front--guestId-information');
Route::get('/about_us', [FrontController::class, 'about_us'])->name('front-about');
...
Route::get('/create-regtest-promo', [FrontController::class, 'createRegtestPromo'])->name('create-regtest-promo');
...
Route::middleware(['auth'])->prefix('admin')->group(function () {
    ...
    Route::get('edit/{encrypted_id}', [CategoryController::class, 'edit'])->name('edit');
    Route::put('update/{encrypted_id}', [CategoryController::class, 'update'])->name('update');
  ...
  Route::prefix('photography')->name('app-photography-')->group(function () {
    /*---- Blog Categry ---*/
    Route::get('list', [PhotographyController::class, 'index'])->name('list');
    Route::get('add', [PhotographyController::class, 'create'])->name('add');
    Route::post('store', [PhotographyController::class, 'store'])->name('store');
    Route::get('edit/{encrypted_id}', [PhotographyController::class, 'edit'])->name('edit');
    Route::put('update/{encrypted_id}', [PhotographyController::class, 'update'])->name('update');
